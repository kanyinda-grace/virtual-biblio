...
MEDIATHÈQUE <b class="caret"></b></a>
                  <ul class="dropdown-menu">
                    <li><a href="Recherche">Photo</a></li>
    ...
    <div class = "container-fluid">
      <div class = "col-lg-2 well" style = "margin-top:60px;">
        <div class = "container-fluid" style = "word-wrap:break-word;">
          <img src = "img/nn.jpeg" style="height:300px;" width = "400px" height = "300px"/>
          <br />
          <br />
        ...
        <ul id = "menu" class = "nav menu">
          ...
          <li><a style = "font-size:18px; border-bottom:1px solid #d3d3d3;" href = "liste_usager.php"><i class = "glyphicon glyphicon-user"></i> Usager </a></li>
      ...
      <div class = "col-lg-9 well" style = "margin-top:60px;">
        <div class = "alert alert-info">LISTE DE TOUS LES USAGERS</div>
 

<div style='color:red;font-size:12px;font-family:verdana;font-weight:bold'>Nombre Total des Usagers : <b style='color:black;font-family:verdana;font-weight:bold'>
  <?php 
            ...
            <table id = "table" class = "table table-bordered">
              <thead class = "alert-success">
                <tr>
                    ...
                    <th class = 'alert alert-info' >DATE D'INSCRIPTION</th>
              ...
              <tbody>
                <?php
                  $qbook = $db->query("SELECT usager.id,usager.username,usager.postnom,usager.prenom,usager.code_sexe,usager.telephone,usager.email,usager.date_inscrit ,
...
join sexe on usager.code_sexe=sexe.code_sexe


join category_usager on usager.id_cat=category_usager.id_cat order by usager.id ASC ") or die("hyhuhu");
                  while($fbook = $qbook->fetch()){
                    
                ?>
                <tr class="po">
                  <td><?php echo $fbook['id']?></td>
                  ...
                  <td><?php echo $fbook['date_inscrit']?></td>
