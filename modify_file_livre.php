...
if (!empty($_FILES)) {
  ...
  $file_extension=strrchr($file_name,".");
    ...
    $req = $db->prepare("UPDATE livre set lien_fichier_livre=:lien_fichier_livre,fichier_livre=:fichier_livre WHERE id_livre=:num LIMIT 1");
 
$req->bindValue(':num',$_POST['modify'],PDO::PARAM_INT);
$req->bindValue(':lien_fichier_livre', $file_desc,PDO::PARAM_STR);
$req->bindValue(':fichier_livre',$file_name,PDO::PARAM_STR);
  ...
  <!-- end header -->
    <div class = "container-fluid">
      ...
      <div class = "col-lg-9 well" style = "margin-top:60px;">
        ...
        <div class = "alert alert-info">MODIFICATION DU FICHIER DU LIVRE</div>
            ...
            <div class = "col-lg-6">
             <form method = "POST"  enctype = "multipart/form-data">
                ...
                <input type="hidden" value="<?= $result['id_livre']; ?>"  name="modify" style="color:black;background-color:white;border-color:silver;width:230px;" class = "form-control"    />
                  ...
                  <input type = "file" name = "uploaded_file" value="<?= $result['lien_fichier_livre']; ?>" style="width:280px" required  class = "form-control" />
                   <input type = "hidden" name = "file_name" value="<?= $result['fichier_livre']; ?>" style="width:280px" required  class = "form-control" />
