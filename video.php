...
<head>
  ...
  <script src="js/main.js"></script>
    <script src="jspp/jquery.js" type="text/javascript"></script>
...
<?php
  ...
  $query = "SELECT video_id,location,title FROM videos";
...
?>
    <?php for($i = 0; $i < mysqli_num_rows($result); $i++){ ?>
        ...
        <a href="#Video_Modal<?php $query_row['video_id']; ?>" data-toggle="modal"> <div id="video">
    <video controls autoplay width="445px" height="300px">
      <source src="video/commercial.mp4" type="video/mp4">
    </video>
  </div>
  <?php echo  $query_row['title'];?> </a><br>
