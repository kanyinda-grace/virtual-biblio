...
<?php
  ...
  $query = "SELECT * FROM livre WHERE titre_ouvrage LIKE '%$search%' or  auteur LIKE '%$search%' or  organ_fin LIKE '%$search%'  or  id_type LIKE '%$search%'  or  id_classe LIKE '%$search%' or  maison_edit LIKE '%$search%' or  description LIKE '%$search%' ";
...
function myFunction() {
  //  $('#demo').css("display", "none");
   ...
   function myFunction()
    {
        var divContenu = div.getElementsByTagName('demo')[1];
