...
Classe <b class="caret"></b></a>
                  <ul class="dropdown-menu">
                    <li><a href="#">Amélioration de l’accès aux soins et traitement </a></li>
                    <li><a href="#">Bonnes pratiques et Directives </a></li>
                    <li><a href="#">Développements et pauvreté </a></li>
                    <li><a href="#">Formations </a></li>
                    <li><a href="#">Justices et Droits Humains  </a></li>
                     <li><a href="#">Politique Nationale  </a></li>
                    <li><a href="#">Plans  </a></li>      
                    <li><a href="#">Prévention du VIH/sida  </a></li>
                    <li><a href="#">Promotion d’un environnement favorable aux PVV et PA    </a></li>
                    <li><a href="#">Recherches et Enquêtes  </a></li>
                    <li><a href="#">Textes légaux  </a></li>
...
Type <b class="caret"></b></a>
                  <ul class="dropdown-menu">
                    ...
                    <li><a href="#">Document officiel</a></li>
                    <li><a href="#">Document partenaire</a></li>
...
MEDIATHÈQUE <b class="caret"></b></a>
                  <ul class="dropdown-menu">
                    <li><a href="Recherche">Galerie</a></li>
...
<?php
  ...
  $query = "SELECT id_livre, images FROM livre where id_classe='BPD' ORDER BY id_livre asc ";
