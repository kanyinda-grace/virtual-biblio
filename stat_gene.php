    ...
    <div class = "container-fluid">
      <div class = "col-lg-2 well" style = "margin-top:60px;">
        ...
        <ul id = "menu" class = "nav menu">
          ...
          <li><a style = "font-size:18px; border-bottom:1px solid #d3d3d3;" href = "stat_gene.php"><i class = "glyphicon glyphicon-book"></i> Consultation </a></li>
            ...
            <div align="right" style="font-size:16px;font-weight:bold"><a href="stat_date.php"style="text-decoration:none;">Rechercher par date </a></div>

      <div class = "col-lg-1"></div>

      <div class = "col-lg-9 well" style = "margin-top:10px;">
        <div class = "alert alert-info">STATISTIQUE DES CONSULTATIONS COMPLETES</div>

  <?php 

$users=$db->prepare("select sum(nombre) as tota from consultation ");
...
//echo $ttgg ; 
 ...
 $sql =$db->query( "SELECT consultation.id ,usager.username ,usager.postnom , usager.prenom,usager.prenom,pays.libelle_pays,category_usager.libelle_cat_usag,
  usager.ville,usager.entre_institut,consultation.jour_cons,consultation.mois_cons,consultation.annee_cons, SUM(consultation.nombre) 
...
$num =$sql->RowCount();
 ...
 ?>
<div style='color:red;font-size:12px;font-family:verdana;font-weight:bold'>Nombre des usagers ayant consulté  :<b style='color:black;font-family:verdana;font-weight:bold'> <?php echo $num ; 
 ?></b>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
        &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
        &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
        &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
        &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
        &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Nombre total des consultations :<b style='color:blue;font-family:verdana;font-weight:bold'> <?php echo $ttgg ; 
 ?></b>
 </div>
            ...
            <table id = "table" class = "table table-bordered">
              <thead class = "alert-success">
                <tr>
                    ...
                    <th class = 'alert alert-info'>Date Consultation</th>
              ...
              <tbody>
                <?php
                  $qbook = $db->query("SELECT consultation.id ,usager.username ,usager.postnom  ,

usager.prenom,usager.prenom,pays.libelle_pays,category_usager.libelle_cat_usag,usager.ville,usager.entre_institut,consultation.jour_cons,consultation.mois_cons,consultation.annee_cons,
SUM(consultation.nombre) AS NOMBRE FROM consultation 

 join usager  on consultation.id=usager.id
...
usager.prenom,usager.ville,usager.entre_institut,consultation.jour_cons,consultation.mois_cons,consultation.annee_cons
  ORDER BY id ASC ") or die("hyhuhu");
                ...
                <tr class="po">
                  ...
                  <td><?php echo $fbook['jour_cons']." ".'/'.$fbook['mois_cons']."".'/'.$fbook['annee_cons']?></td>
