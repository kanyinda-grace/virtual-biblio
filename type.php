...
$libelle_type =htmlspecialchars( $_POST['libelle_type']);

$req=$db->prepare('INSERT INTO type(id_type,libelle_type)VALUES(?,?,)')or die("errororres");
        $req->execute(array($id_type,$libelle_type) )or die("error");
      echo '<p style="color:red">  <script>alert( "Type bien enregistré");window.location.href="";</script> </p>';
		...
		<div class = "container-fluid">
			<div class = "col-lg-2 well" style = "margin-top:60px;">
				...
				<ul id = "menu" class = "nav menu">
					...
					<li><a style = "font-size:18px; border-bottom:1px solid #d3d3d3;" href = "type.php"><i class = "glyphicon glyphicon-user"></i> Type</a></li>
			...
			<div class = "col-lg-9 well" style = "margin-top:60px;">
				<div class = "alert alert-info">GESTION DES TYPES</div>
					<button id = "add_book" type = "button" class = "btn btn-primary"><span class = "glyphicon glyphicon-plus"></span> Ajouter un type</button>
						...
						<table id = "table" class = "table table-bordered">
							<thead class = "alert-success">
								<tr>
									...
									<th class = 'alert alert-info'>Libelle type</th>
									<th class = 'alert alert-info'>Action</th>
								</tr>
							</thead>
							<tbody>
								<?php
									$qbook = $db->query("SELECT * FROM `type`") or die("hyhuhu");
				 ...
				 ?>	    <td>
                  ...
                  <div class="modal-dialog">
                    ...
                    <div class="modal-header">
                      <h4 class="modal-title" id="myModalLabel"><i class="glyphicon glyphicon-user"></i> Type</h4>
                    </div>
						...
						<div class = "col-lg-6">
							<form method = "POST" action = "" enctype = "multipart/form-data">
								<div class = "form-group">
									<label>ID Type:</label>
									<input type = "text" name = "id_type" required = "required" class = "form-control" />
								</div>
								<div class = "form-group">
