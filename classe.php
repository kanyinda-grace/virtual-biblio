...
$libelle_classe =htmlspecialchars( $_POST['libelle_classe']);

$req=$db->prepare('INSERT INTO classe(id_classe,libelle_classe)VALUES(?,?,)')or die("errororres");
        $req->execute(array($id_classe,$libelle_classe) )or die("error");
      echo '<p style="color:red">  <script>alert( "Classe bien enregistrée");window.location.href="";</script> </p>';
		...
		<div class = "container-fluid">
			<div class = "col-lg-2 well" style = "margin-top:60px;">
				...
				<ul id = "menu" class = "nav menu">
					...
					<li><a style = "font-size:18px; border-bottom:1px solid #d3d3d3;" href = "classe.php"><i class = "glyphicon glyphicon-user"></i> Classe</a></li>
			...
			<div class = "col-lg-9 well" style = "margin-top:60px;">
				<div class = "alert alert-info">GESTION DES CLASSES</div>
					<button id = "add_book" type = "button" class = "btn btn-primary"><span class = "glyphicon glyphicon-plus"></span> Ajouter une classe</button>
						...
						<table id = "table" class = "table table-bordered">
							<thead class = "alert-success">
								<tr>
									...
									<th class = 'alert alert-info'>Libelle classe</th>
									<th class = 'alert alert-info'>Action</th>
								</tr>
							</thead>
							<tbody>
								<?php
									$qbook = $db->query("SELECT * FROM `classe`") or die("hyhuhu");
						...
						<div class = "col-lg-6">
							<form method = "POST" action = "" enctype = "multipart/form-data">
								<div class = "form-group">
									...
									<input type = "text" name = "id_classe" required = "required" class = "form-control" />
								</div>
								<div class = "form-group">
									<label>Libelle classe:</label>
									<input type = "text" name = "libelle_classe" class = "form-control" />
								</div>
