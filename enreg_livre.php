    ...
    <div class = "container-fluid">
      <div class = "col-lg-2 well" style = "margin-top:60px;">
        ...
        <ul id = "menu" class = "nav menu">
          ...
          <li><a style = "font-size:18px; border-bottom:1px solid #d3d3d3;" href = "enreg_livre.php"><i class = "glyphicon glyphicon-book"></i> Document</a></li>
      ...
      <div class = "col-lg-9 well" style = "margin-top:60px;">
        <div class = "alert alert-info">GESTION DES DOCUMENTS</div>
          <button id = "add_book" type = "button" class = "btn btn-primary"><span class = "glyphicon glyphicon-plus"></span> Ajouter un document</button>
            ...
            <table id = "table" class = "table table-bordered">
              <thead class = "alert-success">
                <tr >
                  ...
                  <th class = 'alert alert-info'>Source</th>
...
classe.libelle_classe,type.libelle_type,livre.description FROM livre
...
ORDER by livre.id_livre asc") or die("hyhuhu");
         ...
         //echo $num;
         ?>  
                 <td> <a href="modify_file_livre.php<?php echo '?modify='.$id; ?>" style="color:black"><?php echo $fbook['id_livre']?></a></td>
         ...
         <td>
                  ...
                  <td>  <a href="<?php echo $fbook['lien_fichier_livre'] ?>" alt='Download' title='Download' class='btn btn-primary' target='_blank' ><span class = "glyphicon glyphicon-book"></span>&nbsp Voir</a>
     </td>
         ...
         ?>           <td>
                  ...
                  <a class="btn btn-warning" for="ViewAdmin" style="margin:1px" href="modify_livre.php<?php echo '?modify='.$id; ?>">
                  ...
                  <div class="modal-dialog">
                    ...
                    <div class="modal-header">
                      <h4 class="modal-title" id="myModalLabel"><i class="glyphicon glyphicon-book"></i> Livre</h4>
                    </div>
      ...
      <?php
        ...
        ?>
                ...
                <div class = "form-group">
                  ...
                  <textarea type = "text" name = "description" required = "required" class = "form-control" > </textarea>
                </div>
