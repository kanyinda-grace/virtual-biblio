    ...
    <div class = "container-fluid">
      <div class = "col-lg-2 well" style = "margin-top:60px;">
        ...
        <ul id = "menu" class = "nav menu">
          ...
          <li><a style = "font-size:18px; border-bottom:1px solid #d3d3d3;" href = "stat_date_teleche.php"><i class = "glyphicon glyphicon-download"></i> Téléchargement</a></li>
      ...
      <div class = "col-lg-9 well" style = "margin-top:10px;">
        <div class = "alert alert-info">STATISTIQUE DES TELECHARGEMENTS PAR DATE</div>
...
$(document).ready(function(){
  $('#s-results').load('search_date_teleche.php').show();
  ...
  function showValues() {
    ...
    $.post('search_date_teleche.php', { jour: form.jour.value,mois: form.mois.value,annee: form.annee.value, },
