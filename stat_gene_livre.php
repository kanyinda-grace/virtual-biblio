    ...
    <div class = "container-fluid">
      <div class = "col-lg-2 well" style = "margin-top:60px;">
        ...
        <ul id = "menu" class = "nav menu">
          ...
          <li><a style = "font-size:18px; border-bottom:1px solid #d3d3d3;" href = "stat_gene_livre.php"><i class = "glyphicon glyphicon-book"></i> Téléchargement </a></li>
            ...
            <div align="right" style="font-size:16px;font-weight:bold"><a href="stat_date_livre.php"style="text-decoration:none;">Rechercher par date </a></div>

      <div class = "col-lg-1"></div>
      <div class = "col-lg-9 well" style = "margin-top:10px;">
        <div class = "alert alert-info">STATISTIQUE COMPLET DE TELECHARGEMENT DES LIVRES</div>
...
//echo $ttgg ; 
 ...
 $sql =$db->query( "SELECT  livre_telechar.id_livre,livre.id_livre,livre.titre_ouvrage,SUM(livre_telechar.nombre) 
  AS NOMBRE FROM livre_telechar join livre on livre_telechar.id_livre=livre.id_livre GROUP BY livre.id_livre,livre.titre_ouvrage ");
...
$num =$sql->RowCount();
 ...
 ?>
<div style='color:red;font-size:12px;font-family:verdana;font-weight:bold'>Nombre des livres téléchargé  :<b style='color:black;font-family:verdana;font-weight:bold'> <?php echo $num ; 
 ...
 ?></b>
          ...
          <div id = "book_table">
            <table id = "table" class = "table table-bordered">
              ...
              <tbody>
                <?php
                  $qbook = $db->query("SELECT livre.id_livre,livre.titre_ouvrage, SUM(livre_telechar.nombre) 
  AS NOMBRE FROM livre_telechar join livre on livre_telechar.id_livre=livre.id_livre  GROUP BY livre.id_livre,livre.titre_ouvrage ") or die("hyhuhu");
