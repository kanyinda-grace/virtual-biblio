    ...
    <div class = "container-fluid">
      <div class = "col-lg-2 well" style = "margin-top:60px;">
        ...
        <ul id = "menu" class = "nav menu">
          ...
          <li><a style = "font-size:18px; border-bottom:1px solid #d3d3d3;" href = "enreg_livre.php"><i class = "glyphicon glyphicon-user"></i> Consultation</a></li>
      ...
      <div class = "col-lg-9 well" style = "margin-top:60px;">
        <div class = "alert alert-info">STATISTIQUE DES CONSULTATIONS  PAR DATE</div>
...
$(document).ready(function(){
  $('#s-results').load('search_date.php').show();
  ...
  function showValues() {
    ...
    $.post('search_date.php', { jour: form.jour.value,mois: form.mois.value,annee: form.annee.value, },
